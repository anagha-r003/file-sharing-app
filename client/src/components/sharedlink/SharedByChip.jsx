 ...
 * SharedByChip
 * Props:
 *   name   {string} – sender's display name, e.g. "Jerry"
 *   email  {string} – sender's email, e.g. "jerry@vaultlink.io"
 *   initials {string} – avatar initials, e.g. "J"
 */
export default function SharedByChip({
  name = "Jerry",
